...
xstr = xstr+'<div mlib-size="'+xdata[i].size+'" mlib-id="'+xdata[i].id+'" mlib-type="'+xdata[i].type+'" mlib-time="'+xdata[i].newtime+'" mlib-title="'+xdata[i].title+'" mlib-caption="'+xdata[i].caption+'" mlib-url="'+xdata[i].url+'" mlib-thumb="'+xdata[i].thumb+'" class="mlib-thumbs" style="background-image:url(\''+xdata[i].thumb+'\')">\
